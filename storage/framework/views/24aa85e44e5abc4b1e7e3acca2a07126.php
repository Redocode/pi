            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="<?php echo e(route('projects.store')); ?>" method="POST">
                        ...
                        <input type="hidden" name="createur_id" value="<?php echo e(auth()->user()->id); ?>">
...
<?php endif; ?>
<?php /**PATH C:\Users\Kdp\Desktop\leaflet-master\resources\views/projects/create.blade.php ENDPATH**/ ?>